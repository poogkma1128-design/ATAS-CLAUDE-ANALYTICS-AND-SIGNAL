...
## 0AC. ขั้นที่ 2 (ครึ่งแรก) — **สเปกสามกลยุทธ์เขียนเสร็จ · ยังไม่มีโค้ด ยังไม่ register** (2026-09-07)

เอกสารเต็ม: **`docs/STRATEGY_SPEC_V1.md`** — เป็น **ร่างสเปก** ไม่ใช่กฎที่เปิดใช้ ยังไม่มี evaluator
ยังไม่มี strategy version row ยังไม่มี migration 0039 และ **ยังไม่มีคะแนนตัวเลขใด ๆ** (boolean เท่านั้น
ตามคำตัดสิน §0W ที่ยังมีผลอยู่)
...
**รอบนี้ยังเป็นเอกสารล้วน** — ไม่มีโค้ดเปลี่ยน ไม่ apply migration ไม่ deploy ไม่เขียนฐานข้อมูล ·
rollback = revert commit นี้
