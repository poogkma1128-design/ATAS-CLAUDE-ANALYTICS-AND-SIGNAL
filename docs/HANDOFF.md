...
## 0. เริ่มที่นี่ — สถานะ ณ 2026-08-30 03:00 UTC
...
2. **เปิดชาร์ต MNQ/NQ/GC ให้ครบ 3 เซสชัน** — สามตัวนี้หยุดส่งตั้งแต่ 2026-08-28
   ไม่มีข้อมูลก็ตัดสินชะตา MNQU6 ไม่ได้ (ข้อ 5.8)
