...
| ที่ | เห็นอะไร |
|---|---|
| หน้า Indicators → คลิก **Signal Bridge** → แท็บ **About** | เช่น `REV 1.3.1 \| commit 51e2b3e \| built ...` |
...
ระบบถือว่า request ที่มีมากกว่า 1 แท่ง = ข้อมูลย้อนหลัง → **เก็บลง database และนับในสถิติตามปกติ
แต่ไม่แจ้งเตือน** เพราะแท่งพวกนั้นปิดไปนานแล้ว จะแจ้งเฉพาะแท่งที่เพิ่งปิดสด ๆ (request ที่มีแท่งเดียว)
