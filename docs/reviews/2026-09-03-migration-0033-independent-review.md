...
> This file also carries the **independent re-review of migration 0034** near the end. A second,
> separately authored review of 0034 lives in `2026-09-03-migration-0034-independent-review.md` and
> reaches a different verdict; the two are compared in that section's cross-reference block.
